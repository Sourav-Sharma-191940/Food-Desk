        ...
        <table role="table" class="table">
          ...
          <tbody role="rowgroup">
            <tr role="row" v-for="(data,key) in serverData" :key="key">
              ...
              <button class="accept" @click="order_action(data.id,key,'True')">
                <i class="fa fa-check-square-o" aria-hidden="true"></i>
              </button>
              <button class="reject" @click="order_action(data.id,key,'')">
  ...
  data(){
    ...
    methods:{
      order_action(id,key,acceptance_status){
        API.acceptOrder(id,this.User.id,acceptance_status)
        .then(()=>{
