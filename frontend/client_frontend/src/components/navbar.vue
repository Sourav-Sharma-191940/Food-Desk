<template>
    <div>
      ...
      <div class="item" id="item-3">
        <ul class="menulist">
          ...
          <li class="list"><a class="link" href="#">Get App</a></li>
          <li class="list"><a class="link" href="#">Services</a></li>
          <li class="list"><a class="link" href="#">Feedback</a></li>
          <li class="list"><a class="link" href="#">Sign up</a></li>
          <li class="list"><a class="link" href="#popup1">Sign in</a></li>
        </ul>
      </div>
      <div class="item" id="item-4">
        <a  class="cart"><img src="images/cart.png" alt=""></a>
      </div> 
    </nav>
    <!-- navbar ends -->
    ...
    <div class="singindiv">
      <div id="popup1" class="popup">
        ...
        <form action="index_submit" method="get" accept-charset="utf-8">
          ...
          <a href="#" class="sicon"> <img src="images/download.png" alt=""> </a>
          <a href="#" class="sicon"><img src="images/facebook.png" alt=""></a>
          </div>
        </form>
      </div>
    ...
    <nav id="hide-menu" class="hide-menu">
      <div class="photopart">
      <div class="introbox">
        <img class="custimg" src="images/login.png" alt="">
        <p class="hiCustomer">Hi, <span>Customer Name</span></p>
        <p>FoodDesk2020@gmail.com</p>
      </div>
      </div>
      <div class="linksmaindiv">
        <div class="linkslist">
          <div class="links"><img class="linkicon" src="images/home.png" alt=""><a class="linkdev" href="#">Home</a></div>
          <div class="links"><img class="linkicon" src="images/active orders.png" alt=""><a class="linkdev" href="#">Active Orders</a></div>
          <div class="links"><img class="linkicon" src="images/delivered orders.png" alt=""><a class="linkdev" href="#">Delivered Orders</a></div>
          <div class="links"><img class="linkicon" src="images/select hotel.png" alt=""><a class="linkdev" href="#">Select Hotel</a></div>
        </div>
        <hr>
        <p class="communicate">Communicate</p>
        <div class="linkslistdev">
          <div class="links"><img class="linkicon" src="images/share1.png" alt=""><a class="linkdev" href="#">Share</a></div>
          <div class="links"><img class="linkicon" src="images/contact us1.png" alt=""><a class="linkdev" href="#">Contact Us</a></div>
          <div class="links"><img class="linkicon" src="images/about develpoers.png" alt=""><a class="linkdev" href="#">About Developers</a></div>
        </div>
        <hr>
        <div class="loginbuttondiv">
          <button class="loginbutton"><a href="#">Sign up</a></button>
          <button class="loginbutton"><a href="#popup1">Sign In</a></button>
        </div>
      </div>
    </nav>
...
.hide-menu .linksmaindiv .loginbuttondiv {
    display: flex;
    justify-content: center;
}
.hide-menu .linksmaindiv .loginbuttondiv button{
    width: 100px;
    /* height: 25px;
    line-height: 25px; */
    border-radius: 15%;
    /* border: rgb(110, 106, 106); */
    background: lightblue;
    margin: 5px;
}
.hide-menu .linksmaindiv .loginbuttondiv button a{
    font-size: 20px;
}
